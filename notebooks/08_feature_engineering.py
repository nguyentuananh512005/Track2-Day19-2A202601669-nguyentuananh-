...
FEAST_BIN = shutil.which("feast") or (str(Path(sys.executable).parent / "feast.exe") if (Path(sys.executable).parent / "feast.exe").exists() else str(Path(sys.executable).parent / "feast"))
